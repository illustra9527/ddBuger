                    ...
                    <div class="row">
                        <div class="col-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="recipient_phone" name="recipient_phone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="recipient_addresss" class="col-sm col-form-label cus_style">地&emsp;&emsp;址</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="recipient_addresss" name="recipient_addresss">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="recipient_email" class="col-sm col-form-label cus_style">信&emsp;&emsp;箱</label>
                                <div class="col-sm-10">
                                    <input type="mail" class="form-control" id="recipient_email" name="recipient_email">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="recipient_remark" id="" cols="30" rows="5">備註</textarea>
                                </div>
                            </div>
                        </div>
